...
const ARCHETYPE_MAP: Record<Category, { title: string; emoji: string; description: string }> = {
  Creative: {
    title: 'The Creator',
    emoji: '🎨',
    description: 'You express yourself through art, design, and imagination.',
  },
  Making: {
    title: 'The Maker',
    emoji: '🔧',
    description: 'You love turning raw materials into something real and tangible.',
  },
  Physical: {
    title: 'The Athlete',
    emoji: '🏆',
  ...
  Outdoor: {
    title: 'The Explorer',
    emoji: '🌿',
    description: 'You come alive in nature and open spaces.',
  },
  Intellectual: {
    title: 'The Scholar',
    emoji: '📚',
    description: "You're driven by curiosity and love diving deep into ideas.",
  },
  Gaming: {
    title: 'The Strategist',
    emoji: '🎮',
    description: 'You love competition, systems, and mastering complex challenges.',
  },
  Social: {
    title: 'The Connector',
    emoji: '🤝',
    description: 'You energize others and love building community.',
  },
  Culinary: {
    title: 'The Foodie',
    emoji: '🍳',
    description: 'You express love and creativity through food and flavor.',
  },
  Music: {
    title: 'The Musician',
    emoji: '🎵',
    description: "You're drawn to rhythm, melody, and sonic expression.",
  },
  Collecting: {
    title: 'The Curator',
    emoji: '🗂️',
    description: 'You have a keen eye for quality and love curating meaningful things.',
  },
};
...
function getHobbyCategory(hobby: string): Category {
  return (
    (HOBBY_CATEGORIES.find((category) => category.hobbies.includes(hobby))?.name as
      | Category
      | undefined) ?? 'Creative'
  );
}
