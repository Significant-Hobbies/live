...
const ITEMS: { emoji: string; title: string; desc: string }[] = [
  // Legacy & giving back
  {
    ...
    desc: 'A scholarship, a community project, a trust. Something that keeps working after you stop.',
  },
  {
    emoji: '👩‍🏫',
    title: 'Mentor 10 people meaningfully',
    desc: "Not advice over coffee — sustained, intentional mentorship that changes someone's trajectory.",
  },
  {
    emoji: '📖',
    title: 'Write a book',
    desc: 'Memoir, business, fiction. The discipline of writing a book is unlike anything else. The finished object is proof of self.',
  },
  {
    emoji: '🌱',
    title: 'Plant something that will outlive you',
    desc: "Trees, a garden, an orchard. Something that will still be growing when you're gone.",
  },
  {
    emoji: '🎓',
    title: "Fund a child's education from start to finish",
    desc: 'Sponsor a student all the way through school or university. Watch them graduate.',
  },
  {
    emoji: '🏡',
    title: 'Build or restore a home',
    desc: 'Design it yourself, or gut-renovate an old one. Live in something you shaped.',
  },
  {
    emoji: '📜',
    title: 'Write your ethical will',
    desc: 'Not your financial will — your values, lessons, and what you want passed down. The thing that matters.',
  },
  {
    emoji: '🙏',
    title: 'Spend a year volunteering at serious scale',
    desc: 'Not a one-off day — a sustained year where your absence would genuinely set things back.',
  },
  // Depth & expertise
  {
    emoji: '🧠',
    title: 'Become a recognized expert in your field',
    desc: 'Spoken at the conferences, quoted in the coverage, asked to advise. The expertise that earns trust.',
  },
  {
    emoji: '🔬',
    title: 'Learn a second discipline deeply',
    desc: "If you're in medicine, learn law. If you're in business, learn philosophy. Cross-domain mastery changes how you think.",
  },
  {
    emoji: '🌐',
    title: 'Live abroad for at least one full year',
    desc: 'Not a posting, not tourism — actual residency. Shopping, commuting, building local relationships.',
  },
  {
    emoji: '🎭',
    title: 'Perform or exhibit something you made',
    desc: 'A painting show, a musical performance, a comedy night. Make something and put it in front of strangers.',
  },
  {
    emoji: '🤿',
    title: 'Achieve a serious physical certification',
    desc: 'Divemaster, black belt, mountaineering cert. Something that took years and a real grading process.',
  },
  {
    emoji: '📡',
    title: 'Build something that reaches a million people',
    desc: 'A product, a piece of writing, a course, a tool. Something that works at genuine scale.',
  },
  // Body & peak fitness
  {
    emoji: '🏃',
    title: 'Run a marathon',
    desc: 'The full 26.2. After mile 20, everyone discovers something about themselves.',
  },
  {
    emoji: '🏊',
    title: 'Complete a triathlon',
    desc: 'Sprint or Olympic distance at minimum. The swim, the bike, the run — each one humbling for a different reason.',
  },
  {
    emoji: '⛰️',
    title: 'Reach peak physical fitness for your age',
    desc: 'Not for vanity — the kind of fitness that makes everything else in life easier.',
  },
  {
    emoji: '🥋',
    title: 'Earn a black belt or equivalent mastery',
    desc: 'In any martial art or serious physical discipline. The journey is the transformation.',
  },
  {
    emoji: '🧗',
    title: 'Climb something that genuinely frightens you',
    desc: 'A big wall, a serious alpine route, a peak that requires real technical skill.',
  },
  {
    emoji: '🚴',
    title: 'Complete a major cycling challenge',
    desc: 'The Tour de France route, a coast-to-coast, a serious multi-day mountain route.',
  },
  // Family & relationships
  {
    emoji: '👶',
    title: 'Be present for a birth',
    desc: "Your child's, a sibling's, a close friend's. The arrival of life changes the scale of things.",
  },
  {
    emoji: '💍',
    title: 'Renew your vows or celebrate a major partnership milestone',
    desc: "Deliberately, with intention. Not because it's expected — because you mean it more now.",
  },
  {
    emoji: '🤗',
    title: "Repair a relationship you've damaged",
    desc: "The call you've been putting off. Make it.",
  },
  {
    emoji: '🌅',
    title: "Take a trip with your parents before it's too late",
    desc: "While they're well enough to travel. Go somewhere they've always wanted to go.",
  },
  {
    emoji: '🏠',
    title: 'Create a home that feels like you',
    desc: 'Designed, considered, full of things that mean something. A place that tells your story.',
  },
  // Wisdom & reflection
  {
    emoji: '🧘',
    title: 'Do a serious meditation retreat (10+ days)',
    desc: 'Vipassana or equivalent. Ten days of silence resets how you relate to your own mind.',
  },
  {
    emoji: '📚',
    title: 'Read the 100 books you always meant to read',
    desc: "The classics, the philosophy, the history. The ones you nodded along to pretending you'd read.",
  },
  {
    emoji: '🗺️',
    title: 'Lose something significant and rebuild from it',
    desc: "A company, a relationship, a belief. And come back from it with something you didn't have before.",
  },
  {
    emoji: '✍️',
    title: 'Keep a journal for a decade',
    desc: 'Daily or weekly, consistently. Read it back at the end. The person who started it will be a stranger.',
  },
  {
    emoji: '🌓',
    title: 'Change your mind publicly on something important',
    desc: "Find a belief you've held for years and genuinely re-examine it. Change it if the evidence warrants. Say so.",
  },
  // Adventure & experience
  {
    emoji: '🛥️',
    title: 'Sail somewhere that requires real navigation',
    desc: 'An ocean crossing, a serious coastal passage. Not a sunset cruise — actual seamanship.',
  },
  {
    emoji: '🌋',
    title: 'Witness a geological or astronomical event',
    desc: 'A total solar eclipse, an erupting volcano, the aurora. Scale that puts your problems in perspective.',
  },
  {
    emoji: '🏜️',
    title: 'Survive a wilderness expedition',
    desc: 'Multi-day, self-supported, genuinely remote. The kind where your decisions have consequences.',
  },
  {
    emoji: '✈️',
    title: 'Visit every continent',
    desc: "Including Antarctica if you can. Each one has a climate, a culture, a geometry that's unlike anywhere else.",
  },
  {
    emoji: '🎿',
    title: 'Ski or snowboard a black diamond run',
    desc: 'Work up to it. The mountain demands honesty about your limits.',
  },
  // Creative & intellectual
  {
    emoji: '🎬',
    title: 'Make a documentary about something you care about',
    desc: 'Even a short one. The discipline of finding and telling a true story is extraordinary.',
  },
  {
    emoji: '🎵',
    title: 'Record and release music you made',
    desc: 'One song, properly produced. Your voice or your instrument, out in the world.',
  },
  {
    emoji: '🖼️',
    title: 'Have your work shown publicly',
    desc: 'A gallery, a publication, a stage. Something with your name on it, for strangers.',
  },
  {
    emoji: '🏛️',
    title: 'Teach a class or course',
    desc: "Formally or informally — something you know well, passed on to people who don't yet.",
  },
  {
    emoji: '🌍',
    title: 'Speak a second language fluently',
    desc: 'Not at tourist level. Well enough to give a speech, argue a point, make a friend.',
  },
  // Courage & transformation
  {
    emoji: '💰',
    title: 'Make a bet on yourself',
    desc: "Leave the job, fund the project, start the company. Something where you're the asset.",
  },
  {
    emoji: '🤝',
    title: "Forgive someone you haven't forgiven",
    desc: 'For your sake, not theirs. Carrying a grievance through your 40s is a tax you can stop paying.',
  },
  {
    emoji: '🚪',
    title: 'Walk away from something comfortable but wrong',
    desc: 'The job, the relationship, the city. Comfortable and right are different things.',
  },
  {
    emoji: '🌟',
    title: 'Do something that gets you recognized publicly',
    desc: 'An award, a feature, a speaking slot. Not for vanity — for evidence that the work is real.',
  },
  {
    emoji: '🔑',
    title: 'Own something that matters to your community',
    desc: 'A building, a team, a publication. Stewardship is different from ownership.',
  },
  // Will Smith reference — turning 50 as a mission
  {
    emoji: '🎂',
    title: 'Turn your next decade birthday into a mission',
    desc: 'Will Smith skydived for his 50th. Make yours a declaration, not a dinner party.',
  },
  {
    emoji: '🌊',
    title: 'Swim in all five oceans',
    desc: 'Pacific, Atlantic, Indian, Arctic, Southern. A slow, deliberate life goal that forces extraordinary travel.',
  },
  {
    emoji: '🏆',
    title: 'Win something you genuinely competed for',
    desc: 'A race, a pitch, a competition. Something where other people were trying to beat you.',
  },
  {
    emoji: '📰',
    title: 'Be quoted or profiled in the press',
    desc: 'For something real — your expertise, your work, your cause. Not a PR stunt.',
  },
  {
    emoji: '🧬',
    title: 'Understand your own health at a deep level',
    desc: 'Full bloodwork, genetics, a proper physical baseline. Know your body before it tells you something is wrong.',
  },
  {
    emoji: '🌙',
    title: 'Watch the sunrise from a place that moved you',
    desc: 'Not a beach resort — somewhere that earned the view. A summit, a desert, a cliffside you walked to.',
  },
];
