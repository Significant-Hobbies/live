...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://live.significanthobbies.com/manifesto' },
};
    ...
    <div className="relative mx-auto max-w-2xl px-4 py-16 sm:py-24">
      ...
      <div className="relative">
        ...
        <article className="mt-8 space-y-6">
          <h1 className="font-serif text-2xl font-semibold text-foreground">Manifesto</h1>

          <p className="text-base text-foreground leading-relaxed">
            You have about 4,000 weeks. If you&apos;re 30, you&apos;ve spent roughly 1,560 of them.
            If you&apos;re 40, it&apos;s 2,080. The number is not large.
          </p>
          ...
          <p className="text-base text-muted-foreground leading-relaxed">
            ...
            you learned to play your first song. The week you hiked a mountain you&apos;d been
            staring at for years. The week you cooked something you didn&apos;t know you could make.
          </p>
          ...
          <div className="rounded-xl border border-border bg-card/40 p-6 shadow-soft">
