...
export const HOBBY_AFFINITIES: Record<string, HobbyAffinity[]> = {
  ...
  Drawing: [
    {
      name: 'Woodworking',
      reason: 'Both reward patience, design thinking, and making something by hand',
    },
  ...
  Knitting: [
    ...
    {
      name: 'Gardening',
      reason: 'Natural, tactile, patient — the same personality gravitates to both',
    },
  ],
  Poetry: [
  ...
  'Music production': [
    ...
    {
      name: 'Philosophy',
      reason: 'Sound design raises real questions about perception and aesthetics',
    },
  ],
  Songwriting: [
    ...
    {
      name: 'Yoga',
      reason: 'Creative blocks often clear when the body is moving and the mind is quiet',
    },
  ],
  ...
  Piano: [
    {
      name: 'Chess',
      reason: 'Both reward deep pattern learning through slow, deliberate practice',
    },
  ...
  DJing: [
    {
      name: 'Dance',
      reason: 'DJs and dancers are symbiotic — playing for dancers changes your ear',
    },
  ...
  Violin: [
    {
      name: 'Chess',
      reason: 'Long arcs of deliberate practice; plateau-busting requires the same patience',
    },
  ...
  Running: [
    ...
    {
      name: 'Bird watching',
      reason: "Same trails, slower pace — you'll notice things you never saw at speed",
    },
  ],
  Cycling: [
  ...
  Hiking: [
    ...
    {
      name: 'Bird watching',
      reason: 'Slow the pace and the trail becomes a completely different experience',
    },
    {
      name: 'Cooking',
      reason: 'Trail food and camp meals make the journey as good as the destination',
    },
  ],
  Yoga: [
    ...
    {
      name: 'Reading',
      reason: 'Philosophy and contemplation are natural companions to the practice',
    },
  ...
  'Martial arts': [
    {
      name: 'Reading',
      reason: 'Philosophy, strategy, and discipline theory run deep in the tradition',
    },
    {
      name: 'History',
  ...
  Dance: [
    ...
    {
      name: 'Improv comedy',
      reason: 'Both require total physical presence and willingness to look foolish',
    },
  ],
  Swimming: [
    {
  ...
  Reading: [
    ...
    {
      name: 'Coffee brewing',
      reason: "A ritual that pairs naturally — they've been together for centuries",
    },
  ],
  Chess: [
    {
    ...
    {
      name: 'Yoga',
      reason: 'Mental clarity from physical practice transfers to over-the-board decisions',
    },
  ],
  Coding: [
    ...
    {
      name: 'Video games',
      reason: 'The gap between player and builder collapses fast once you can code',
    },
  ...
  Astronomy: [
    ...
    {
      name: 'Photography',
      reason: 'Astrophotography is one of the most technically rewarding genres',
    },
    {
      name: 'Camping',
      reason: 'Dark skies require getting out of the city — camping gets you there',
    },
  ],
  ...
  'Board games': [
    { name: 'Chess', reason: 'Deep strategic thinking across a much wider game space' },
    {
      ...
      reason: 'Games are better with people — the dinner table is the natural venue',
    },
  ...
  'Tabletop RPGs': [
    ...
    {
      name: 'Improv comedy',
      reason: 'Same muscle — yes-and, character commitment, building on the moment',
    },
  ...
  'Dungeon Master': [
    {
      name: 'Writing',
      reason: 'Every campaign is a collaborative novel — worldbuilding is writing',
    },
  ...
  Gardening: [
    ...
    {
      name: 'Writing',
      reason: 'Garden journaling tracks patterns across seasons better than memory',
    },
  ],
  'Bird watching': [
  ...
  Camping: [
    ...
    {
      name: 'Photography',
      reason: 'Dark skies and golden light make campsites exceptional shooting locations',
    },
  ...
  'Coffee brewing': [
    ...
    {
      name: 'Science',
      reason: 'Water chemistry, extraction, and roast curves are genuinely scientific',
    },
  ],
  'Wine tasting': [
    {
  ...
  BBQ: [
    {
      name: 'Woodworking',
      reason: 'Many BBQ devotees build their own smokers — the crafts overlap',
    },
    {
      name: 'Science',
      reason: 'The chemistry of smoke, time, and temperature is real and interesting',
    },
  ...
  Books: [
    ...
    {
      name: 'Book club',
      reason: "A collection is more meaningful when it's in conversation with others",
    },
    {
      name: 'Coffee brewing',
      reason: 'The reading-coffee ritual is ancient and worth building deliberately',
    },
  ],
  Art: [
  ...
  Woodworking: [
    {
      name: 'Drawing',
      reason: 'Sketching designs before cutting wood saves timber and reveals ideas',
    },
    {
      name: 'Yoga',
      reason: 'Physical focus and slow deliberate movement — the same mindset in a different shop',
    },
    {
      name: 'Cooking',
      reason:
        'Cutting boards, spoons, and serving boards — the two hobbies feed each other literally',
    },
  ],
  '3D printing': [
  ...
  'Candle making': [
    {
      name: 'Yoga',
      reason: 'Scent and atmosphere — candles are already embedded in mindfulness practice',
    },
  ...
  'Improv comedy': [
    ...
    {
      name: 'Tabletop RPGs',
      reason: 'Yes-and lives in both — the skills transfer almost completely',
    },
  ],
  Theater: [
  ...
  Travel: [
    ...
    {
      name: 'Language learning',
      reason: 'Speaking even 50 words of the local language transforms the trip',
    },
    {
      name: 'History',
      reason: 'Knowing the history makes you read the place rather than just see it',
    },
  ],
};
