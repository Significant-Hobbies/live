...
export const FAMOUS_BUCKET_LISTS: FamousBucketList[] = [
  {
    ...
    items: [
      {
        ...
        description:
          "Leap into one of the world's most iconic landscapes from a hovering helicopter.",
        category: 'adventure',
        status: 'done',
    ...
    sources: [
      {
        label: "Variety – Facebook Watch 'Bucket List' series (2019)",
        url: 'https://variety.com/2019/digital/news/will-smith-bucket-list-facebook-watch-1203150965/',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        status: 'done',
        completedNote:
          "Went to Richard Branson's Necker Island less than a month after leaving the White House. Beat Branson in a kitesurf vs. foilboard challenge.",
      },
      {
        ...
        status: 'done',
        completedNote:
          'Visited during the 2014 NATO summit — "knocked it off the bucket list" in his own words.',
      },
      {
        ...
        status: 'done',
        completedNote:
          'Founded Higher Ground Productions; signed a landmark deal with Netflix to produce films and series.',
      },
      {
        ...
        status: 'done',
        completedNote:
          'Published A Promised Land in November 2020 — it sold 890,000 copies on its first day.',
      },
    ],
    quote: {
    ...
    sources: [
      {
        label: 'CNN Politics – Obama kitesurfing on Necker Island (Feb 2017)',
        url: 'https://www.cnn.com/2017/02/07/politics/barack-obama-kitesurfing-richard-branson/index.html',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          'Float from mainland to mainland across 3,000 miles of open ocean in a balloon.',
        category: 'adventure',
        status: 'done',
        completedNote:
          'Completed in 1987, setting a Guinness World Record for the fastest Atlantic crossing by balloon.',
      },
      {
      ...
      },
      {
        ...
        status: 'done',
        completedNote:
          "Flew aboard Virgin Galactic's VSS Unity in July 2021, beating Jeff Bezos to space by nine days.",
      },
      {
    ...
    sources: [
      {
        label: 'Virgin Galactic – first fully crewed spaceflight (Jul 2021)',
        url: 'https://www.virgingalactic.com/articles/virgin-galactic-completes-first-fully-crewed-spaceflight/',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        status: 'done',
        completedNote:
          'His 2010 annual challenge. Delivered a 30-minute Q&A entirely in Mandarin at Tsinghua University in 2014.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Create a voice-controlled AI that manages lights, music, temperature, and your day.',
        category: 'achievement',
        status: 'done',
        completedNote:
          "His 2016 challenge. Built 'Jarvis,' voiced by Morgan Freeman, that controlled his home and learned his preferences.",
      },
      {
    ...
    sources: [
      {
        label: 'Inc. – How Zuckerberg keeps his personal challenges (2016)',
        url: 'https://www.inc.com/julie-anne-exter/how-mark-zuckerberg-keeps-his-ridiculously-challenging-new-years-resolutions.html',
      },
    ],
  },
  {
    ...
    name: 'Oprah Winfrey',
    knownFor:
      'Media mogul and philanthropist who builds her bucket list around sensory experiences',
    emoji: '📺',
    items: [
      {
        title: 'Go truffle hunting in Italy',
        description:
          'Trek through Florentine forests with trained pigs and dogs hunting the rarest fungi.',
        category: 'travel',
        status: 'done',
        completedNote:
          'Planned every summer for years before finally doing it with Gayle King in Tuscany in 2014.',
      },
      {
        title: 'Hot air balloon ride over the Serengeti',
        description:
          'Drift at dawn over the African savanna watching wildlife move across the plains.',
        category: 'travel',
        status: 'done',
        completedNote:
          'Completed on safari with partner Stedman Graham — she described it as one of the most peaceful experiences of her life.',
      },
      {
    ...
    sources: [
      {
        label: 'E! Online – Oprah checks truffle hunting off her bucket list (Oct 2014)',
        url: 'https://www.eonline.com/news/588680/oprah-winfrey-checks-another-item-off-her-bucket-list-truffle-hunting-with-gayle-king-in-italy',
      },
    ],
  },
  {
    ...
    sources: [
      {
        label: 'CBS News – Clinton bucket list: Kilimanjaro and grandkids',
        url: 'https://www.cbsnews.com/news/bill-clintons-bucket-list-seeing-grandkids-and-climbing-kilimanjaro/',
      },
      {
        label: 'ABC News – Clinton bucket list includes riding horse in Mongolia',
        url: 'https://abcnews.go.com/Politics/bill-clinton-bucket-list-includes-riding-horse-mongolia/story?id=25707905',
      },
    ],
  },
  {
    ...
    knownFor:
      'Tennis legend whose post-retirement bucket list is built around wilderness and family',
    emoji: '🎾',
    items: [
      {
        title: 'Hike the Pacific Crest Trail end to end',
        description:
          "Walk 2,650 miles from Mexico to Canada through some of America's wildest terrain.",
        category: 'adventure',
        status: 'planned',
      },
      {
      ...
      },
      {
        ...
        description:
          "Experience humanity's greatest achievements through the eyes of the people you love most.",
        category: 'travel',
        status: 'planned',
      },
      {
    ...
    sources: [
      {
        label: "SportsKeeda – Serena Williams' plans after retirement",
        url: 'https://www.sportskeeda.com/tennis/tennis-chosen-i-loved-choice-now-first-time-entire-life-i-m-choosing-something-serena-williams-plans-ambitions-following-retirement-tennis',
      },
    ],
  },
  {
    ...
    items: [
      {
        title: 'Die on Mars',
        description:
          'Not the dying part — but living on another planet long enough that Mars becomes home.',
        category: 'adventure',
        status: 'planned',
      },
      {
    ...
    sources: [
      {
        label: "Futurism – Elon Musk's main goal: get humanity to Mars before he dies",
        url: 'https://futurism.com/the-byte/elon-musk-main-goal-get-humanity-mars-before-die',
      },
    ],
  },
  {
    ...
    name: 'Bill Gates',
    knownFor:
      'Microsoft co-founder who traded personal bucket-list items for philanthropic missions',
    emoji: '💊',
    items: [
      {
      ...
      },
      {
        ...
        status: 'done',
        completedNote:
          'Visited Antarctica as one of his personal travel milestones alongside his philanthropic work.',
      },
      {
    ...
    sources: [
      {
        label: 'Benzinga – what Bill Gates has left on his bucket list (Jan 2025)',
        url: 'https://www.benzinga.com/personal-finance/25/01/42992135/billionaire-bill-gates-was-asked-whats-left-on-his-bucket-list-he-reveals-theres-only-one-thing-dont-die',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          'Take the stage in a live Broadway production — no second takes, no safety net.',
        category: 'creative',
        status: 'planned',
      },
      {
        ...
        status: 'done',
        completedNote:
          "Co-starred in Spirited (2022). Called it 'an experience of a lifetime' and 'a bucket list item forever.'",
      },
    ],
    quote: {
    ...
    sources: [
      {
        label: 'Broadway World – Ryan Reynolds: Broadway is on the bucket list (Jul 2015)',
        url: 'https://www.broadwayworld.com/article/Ryan-Reynolds-Exchanged-Broadway-for-Parenthood-Broadways-On-the-Bucket-List-20150711',
      },
    ],
  },
  {
    ...
    sources: [
      {
        label: 'Yahoo Entertainment – Shaq shares last things on his bucket list',
        url: 'https://www.yahoo.com/entertainment/shaquille-oneal-shares-last-things-212049793.html',
      },
    ],
  },
  {
    ...
    name: 'Dwayne Johnson',
    knownFor:
      'Actor and former wrestler whose bucket list extends into creative and artistic dreams',
    emoji: '💪',
    items: [
      {
        ...
        status: 'done',
        completedNote:
          "Made Red One (2024) with Amazon MGM. Called it 'a bucket list thing now checked off.'",
      },
      {
    ...
    sources: [
      {
        label: 'IMDb News – Dwayne Johnson on Red One as a bucket list achievement (2024)',
        url: 'https://m.imdb.com/news/ni64938197',
      },
    ],
  },
];
