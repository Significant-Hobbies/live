      ...
      phases: [
        {
          ...
          order: 0,
          hobbies: [{ name: 'Electronics tinkering' }, { name: 'Swimming' }, { name: 'Reading' }],
        },
        {
          id: 'sj2',
          label: 'College / Early Career',
          order: 1,
          hobbies: [{ name: 'Calligraphy' }, { name: 'Yoga' }, { name: 'Meditation' }],
        },
        {
          id: 'sj3',
          label: 'Peak Career (Apple era)',
          order: 2,
          hobbies: [{ name: 'Walking' }, { name: 'Meditation' }, { name: 'Reading' }],
        },
      ],
    },
  },
      ...
      phases: [
        {
          ...
          order: 0,
          hobbies: [{ name: 'Violin' }, { name: 'Reading' }, { name: 'Puzzles' }],
        },
        {
          id: 'ae2',
        ...
        },
        {
          ...
          order: 2,
          hobbies: [{ name: 'Violin' }, { name: 'Sailing' }, { name: 'Reading' }],
        },
      ],
    },
  },
      ...
      phases: [
        {
          ...
          order: 0,
          hobbies: [{ name: 'Electronics tinkering' }, { name: 'Puzzles' }, { name: 'Reading' }],
        },
        {
          id: 'rf2',
          label: 'MIT / Los Alamos',
          order: 1,
          hobbies: [{ name: 'Drums' }, { name: 'Puzzles' }, { name: 'Lock picking' }],
        },
        {
          id: 'rf3',
          label: 'Caltech years',
      ...
      phases: [
        {
          ...
          order: 0,
          hobbies: [{ name: 'Basketball' }, { name: 'Tennis' }, { name: 'Golf' }],
        },
        {
          id: 'jc2',
          label: 'WWII / OSS (20s-30s)',
          order: 1,
          hobbies: [{ name: 'Writing' }, { name: 'Travel' }],
        },
        {
          id: 'jc3',
          label: 'Paris (age 36+)',
          order: 2,
          hobbies: [{ name: 'Cooking' }, { name: 'Writing' }, { name: 'Wine tasting' }],
        },
        {
          id: 'jc4',
      ...
      phases: [
        {
          ...
          order: 0,
          hobbies: [{ name: 'Basketball' }, { name: 'Reading' }, { name: 'Bodysurfing' }],
        },
        {
          id: 'bo2',
          label: 'College / Community organizing',
          order: 1,
          hobbies: [{ name: 'Basketball' }, { name: 'Writing' }, { name: 'Reading' }],
        },
        {
          id: 'bo3',
          label: 'Presidency',
      ...
      phases: [
        {
          ...
          label: 'Childhood',
          order: 0,
          hobbies: [{ name: 'Chess' }, { name: 'Physical fitness' }],
        },
        {
          id: 'as2',
        ...
        },
        {
          ...
          label: 'Later Life',
          order: 3,
          hobbies: [{ name: 'Chess' }, { name: 'Reading' }, { name: 'Classical music' }],
        },
      ],
    },
  },
    ...
    timeline: {
      ...
      phases: [
        ...
        },
        {
          ...
          order: 1,
          hobbies: [{ name: 'Music (lyre)' }, { name: 'Singing' }, { name: 'Anatomy dissection' }],
        },
        {
          id: 'ldv3',
          label: 'Career',
    ...
    timeline: {
      ...
      phases: [
        ...
        },
        {
          ...
          label: 'Later Life',
          order: 3,
          hobbies: [{ name: 'Beekeeping (80,000 bees)' }, { name: 'Cooking' }, { name: 'Family' }],
        },
      ],
    },
  },
