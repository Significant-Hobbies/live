...
const baselines = {
  ...
  duplication: {
    clones: 49,
    duplicatedLines: 762,
    // Removing obsolete Live surfaces reduced duplicate lines but also reduced
    // total production LOC, so the percentage denominator moved upward.
    percentage: 1.3441524078320692,
  },
  unused: {
    files: 0,
    exports: 0,
